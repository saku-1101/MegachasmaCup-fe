...
export type GetMyNotesQuery = { getNotes: Array<{ id: string, userId: string, classId: string, title: string, description: string, tags: Array<{ id: string, name: string }>, likeUser: Array<{ id: string }> }> };
