...
export type GetLikedNotesOfUserQuery = {
  getUser: Array<{
    userLikes: Array<{
      id: string;
      classId: string;
...
export type GetPrivateNotesOfUserQuery = {
  getNotes: Array<{
    id: string;
    classId: string;
    title: string;
...
export type GetAccountSettingsQuery = {
  getUser: Array<{
    ...
    name: string;
    email: string;
    userSchool: Array<{ id: string; name: string }>;
  }>;
};
...
export type GetClassesOfUserQuery = {
  getClasses: Array<{
    id: string;
    name: string;
    classSchool: { id: string; name: string };
    classStudents: Array<{ id: string }>;
  }>;
};
      ...
      variableDefinitions: [
        {
          ...
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'NewUser' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'UpdateUserProps' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'NewNote' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'UpdateNoteProps' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'NewClass' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'UpdateClassProps' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'NewSchool' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'UpdateSchoolProps' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'UpdateCommentProps' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'NewTag' } } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'JoinClass' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
...
} as unknown as DocumentNode<JoinClassMutation, JoinClassMutationVariables>;
export const JoinSchoolDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'JoinSchool' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'schoolID' } },
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } } },
        },
      ],
      selectionSet: {
            ...
            arguments: [
              {
                ...
                value: { kind: 'Variable', name: { kind: 'Name', value: 'schoolID' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
...
} as unknown as DocumentNode<JoinSchoolMutation, JoinSchoolMutationVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'GetMyNotes' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'GetNoteProps' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
...
} as unknown as DocumentNode<GetMyNotesQuery, GetMyNotesQueryVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getLikedNotesOfUser' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'GetUserProps' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'userLikes' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<GetLikedNotesOfUserQuery, GetLikedNotesOfUserQueryVariables>;
export const GetPrivateNotesOfUserDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getPrivateNotesOfUser' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
...
} as unknown as DocumentNode<GetPrivateNotesOfUserQuery, GetPrivateNotesOfUserQueryVariables>;
export const GetAccountSettingsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getAccountSettings' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'userSchool' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<GetAccountSettingsQuery, GetAccountSettingsQueryVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'getClassesOfUser' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'input' } },
          type: { kind: 'NamedType', name: { kind: 'Name', value: 'GetClassesProps' } },
        },
      ],
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'classSchool' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'classStudents' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [{ kind: 'Field', name: { kind: 'Name', value: 'id' } }],
                  },
...
} as unknown as DocumentNode<GetClassesOfUserQuery, GetClassesOfUserQueryVariables>;
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'searchWord' } },
          type: { kind: 'NonNullType', type: { kind: 'NamedType', name: { kind: 'Name', value: 'String' } } },
        },
      ],
      selectionSet: {
            ...
            arguments: [
              {
                ...
                value: { kind: 'Variable', name: { kind: 'Name', value: 'searchWord' } },
              },
            ],
            selectionSet: {
              kind: 'SelectionSet',
...
} as unknown as DocumentNode<GetSchoolsQuery, GetSchoolsQueryVariables>;
