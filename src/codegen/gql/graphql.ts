...
export type DecrementLikeMutation = { like: { likeUser: Array<{ id: string }> } };
...
export type GetNoteQuery = { getNotes: Array<{ id: string, title: string, description: string, userId: string, tags: Array<{ id: string, name: string }>, likeUser: Array<{ id: string }>, comments: Array<{ id: string, comment: string }> }> };
