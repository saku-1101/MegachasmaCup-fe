...
export type GetClassesOfUserQuery = { getClasses: Array<{ id: string, name: string, classSchool: { id: string, name: string }, classStudents: Array<{ id: string }> }> };
...
export type GetNotesQuery = { getNotes: Array<{ id: string, description: string, tags: Array<{ id: string, name: string }>, likeUser: Array<{ id: string }> }> };
...
export type GetNoteQuery = { getNotes: Array<{ id: string, description: string, tags: Array<{ id: string, name: string }>, likeUser: Array<{ id: string }>, comments: Array<{ id: string, comment: string }> }> };
